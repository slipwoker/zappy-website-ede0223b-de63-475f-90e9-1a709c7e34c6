document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, name, extra) {
    const messages = {
  ...
  function handleFormSuccess(form) {
    ...
    successEl.textContent = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'ede0223b-de63-475f-90e9-1a709c7e34c6',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'ede0223b-de63-475f-90e9-1a709c7e34c6';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +972509988213 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ede0223b-de63-475f-90e9-1a709c7e34c6';
